# Generated by Django 2.2 on 2020-12-23 02:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('company_master', '0003_delete_companydata'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            name='CompanyData',
            fields=[
                ('CORPORATE_IDENTIFICATION_NUMBER', models.CharField(max_length=250, primary_key=True, serialize=False)),
